      ...
      >
        <div className="flex items-center gap-2">
          ...
          <div className="text-left">
            <h3 className="text-sm font-bold text-white">River Levels</h3>
        ...
        <div className="border-t border-gray-700/40">
          ...
          {loading && readings.length === 0 ? (
            <div className="px-4 py-8 text-center">
              ...
              <p className="text-xs text-gray-400">Fetching river data...</p>
            </div>
          ) : (
            <div className="max-h-[400px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-600">
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[10px] text-gray-400 truncate">{reading.stationName}</p>
                      </div>
                      ...
                      <div className="px-4 pb-3 bg-gray-800/30 space-y-2">
                        ...
                        {reading.thresholds && (
                          <div className="space-y-1">
                            <p className="text-[10px] font-medium text-gray-300">Thresholds</p>
              ...
              {sorted.length === 0 && !loading && (
                <div className="px-4 py-6 text-center text-xs text-gray-400">
                  No river monitoring stations configured
                </div>
              )}
            </div>
          )}
