    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-white py-12 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex items-center gap-3 mb-3"><FileText className="w-7 h-7 text-blue-400" /><h1 className="text-2xl font-bold">{t('footer.terms', 'Terms of Use')}</h1></div>
