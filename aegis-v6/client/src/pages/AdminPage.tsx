...
export default function AdminPage(): JSX.Element {
  ...
  },[reports,searchTerm,filterSeverity,filterStatus,filterType,smartFilter])
      ...
      {selReport&&(()=>{
        ...
        const getRecommendedActions = () => {
          ...
          if (cat === 'natural_disaster') {
            if (sev === 'High') return ['Deploy flood response teams immediately','Activate emergency evacuation protocols','Engage local flood barriers & pumps','Issue mandatory evacuation alert via all channels','Coordinate with Environment Agency/SEPA']
            if (sev === 'Medium') return ['Monitor water levels hourly','Pre-position sandbags and pumps','Alert nearby communities','Review evacuation route accessibility']
            return ['Log for pattern analysis','Continue environmental monitoring','Update flood risk model']
          }
